...
## Datasets
Make a /data directory before running the model and store the data and the glove embeddings beforehand.
...
```
The model will be saved the folder models.
...
## Task 1
## Task 1_1 Generating Explainations
```bash
python task1_1.py

```
The results are going to be stored in a folder explainations.
## Task 1_1 Printing Explainations and visualising the results
```bash
python task1_2.py

```
The results plots are going to be stored in a folder explainations/plots_alt.

## Task 2
## Adverserial Attacks training and evaluation
```bash
python task2.py

```
The saved model is going to be first trained on 10 epochs, by default and then evaluated on the test set. The results are going to be printed as output.
